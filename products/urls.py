...
from .views import BrandListView, CategoryRootListView, ProductListView, ProductDetailView, CategoryListView, ReviewCreateView, ReviewDetailView, ReviewListView, TagListView

urlpatterns = [
    path('products/', ProductListView.as_view(), name='product-list'),
    path('products/<str:slug>/', ProductDetailView.as_view(), name='product-detail'),
    path('categories/', CategoryListView.as_view(), name='category-list'),
    path('categories/root/', CategoryRootListView.as_view(), name='category-root-list'),
